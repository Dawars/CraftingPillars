...
public abstract class PacketCraftingPillar extends PacketBase {

	private ByteArrayOutputStream arrayout;
	private DataOutputStream dataout;
	public DataInputStream datain;

	public PacketCraftingPillar() {

		arrayout = new ByteArrayOutputStream();
		dataout = new DataOutputStream(arrayout);
	}

	public PacketCraftingPillar(byte[] data) {

		datain = new DataInputStream(new ByteArrayInputStream(data));
	}

	public PacketCraftingPillar addString(String theString) {
	...
	public PacketCraftingPillar addUUID(UUID theUUID) {
	...
	public PacketCraftingPillar addLong(long theLong) {
	...
	public PacketCraftingPillar addInt(int theInteger) {
	...
	public PacketCraftingPillar addVarInt(int theInteger) {
	...
	public PacketCraftingPillar addBool(boolean theBoolean) {
	...
	public PacketCraftingPillar addByte(byte theByte) {
	...
	public PacketCraftingPillar addByte(int theByte) {

		return addByte((byte) theByte);
	}

	public PacketCraftingPillar addShort(short theShort) {
	...
	public PacketCraftingPillar addShort(int theShort) {

		return addShort((short) theShort);
	}

	public PacketCraftingPillar addByteArray(byte theByteArray[]) {
	...
	public PacketCraftingPillar addFloat(float theFloat) {
	...
	public PacketCraftingPillar addItemStack(ItemStack theStack) {
	...
	public PacketCraftingPillar addFluidStack(FluidStack theStack) {
	...
	public PacketCraftingPillar addCoords(TileEntity theTile) {
	...
	public PacketCraftingPillar addCoords(int x, int y, int z) {
