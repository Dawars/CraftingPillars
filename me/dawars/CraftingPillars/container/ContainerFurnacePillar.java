...
public class ContainerFurnacePillar extends Container
{
    ...
    public ContainerFurnacePillar(InventoryPlayer par1InventoryPlayer, TileEntityFurnace par2TileEntityFurnace)
    {
